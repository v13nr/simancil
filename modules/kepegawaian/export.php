...
h4 { font-size:36px}
	...
	<table width="1800" border="1" cellspacing="1">
	 <tr>
		<td colspan="12"><h2>Daftar Pegawai <?=$namaclient?></h2></td>
	  </tr>
	...
	<? 
 	...
 	?>
	<tr valign="top">
    <td height="76" align="center" class="style3"><?=++$id?></td>
      ...
      <td class="style3"><?=$row['namajab']?></td>
      <td class="style3" align="center"><?=baliktglindo($row['mulkerja'])?></td>
      <td class="style3" align="center"><?=$row['ri_pendidikan']?></td>
      <td class="style3" align="center"><?=$row['ri_pekerjaan']?></td>
      <td class="style3" align="center"><?=$row['ri_keluarga']?></td>
    </tr>
    <? } ?>
	</table>