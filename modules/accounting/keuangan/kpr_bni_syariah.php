...
<table width="90%" border="1" style="border-collapse:collapse">
  <tr>
    ...
    <td colspan="6"><div align="center">USER KPR BNI SYARIAH </div></td>
    <td>&nbsp;</td>
  ...
  <?php
	...
	if(isset($_GET['id'])){
		$sql = mysql_query("SELECT * FROM kpr_bnisy WHERE id = '".$_GET['id']."' ORDER BY nama");
  ...
  <tr>
	...
	<input name="cmd" type="hidden" value="<?php echo isset($_GET['id']) ? 'upd_kpr_bnisy' : 'add_kpr_bnisy'; ?>">
	...
	?>
		...
		<tr>
			...
			<td>
				<a href="submission_keu.php?cmd=del_kpr_bnisy&id=<?php echo $data['id']; ?>" onclick="return confirm('Apakah anda yakin ?')">Delete</a>
				<a href="?mn=kpr_bnisy&id=<?php echo $data['id']; ?>">Edit</a>			</td>
		</tr>
	<?php
			$no++;
		}
