...
<table width="90%" border="1" align="center">
  ...
  <tr>
    ...
    <td><div align="center"><a href="opname_detail.php?id=<?php  echo $baris["id"];?>&tanggal=<?php  echo baliktglindo($baris["tanggal"]);?>&keterangan=<?php  echo ($baris["keterangan"]);?>"></a>&nbsp;&nbsp;<a href="opname_cetak.php?id=<?php  echo $baris["id"];?>&tanggal=<?php  echo baliktglindo($baris["tanggal"]);?>&keterangan=<?php  echo ($baris["keterangan"]);?>">Cetak</a></div></td>
  </tr>
  <?php  } ?>
</table>
