...
cekAkses($_SESSION["sess_user_id"], 'jurnal_form_kasmasuk');
 ?>
<style type="text/css">
<!--
body {
...
$(document).ready(function() {
  ...
  <tr>
	...
	<form name="frmijin" id="frmijin" method="post" action="submission_gli.php">
      ...
      <tr>
        <td>No. Perkiraan </td>
        <td><input type="text" name="norek" id="norek" readonly="true" maxlength="8" size="10" class="requireb" title="*" value="" <?php  if($_GET['norek']<>""){?> <?php  } ?> />
		<?php  if($_GET['norek']==""){?>
        <a href="daftar_rekkas.php?width=400&amp;height=350&amp;TB_iframe=true" class="thickbox"><img src="../assets/button_search.png" alt="Pilih Akun" border="0" /></a>
		<?php  } ?>
		<input type="hidden" name="namarek" size="30" value="Kas" readonly="true" />        </td>
      </tr>
      <tr>
        <td>Keterangan </td>
        <td><input type="text" name="keteranganheader" size="50" class="required" title="*" value="Kas"  <?php  if($_GET['keteranganheader']<>""){?>  <?php  } ?>></td>
      </tr>
      <tr>
        <td>TOTAL</td>
        <td>
