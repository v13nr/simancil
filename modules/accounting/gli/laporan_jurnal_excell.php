...
<br />
<form method="post" action="cetak_jurnal_excell.php" id="frmijin">
<table width="476" align="center" cellspacing="1" bgcolor="#000000">
	...
	<tr bgcolor="#FFFFCC">
		...
		<td width="126"><input type="text" name="tgl_awal" id="tgl_awal" size="10" class="required" value="01-01-2010" title="Harap Mengisi Tanggal Awal Dahulu" />
