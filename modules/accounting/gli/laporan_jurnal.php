...
<table width="476" align="center" cellspacing="1" bgcolor="#000000">
	...
	<tr bgcolor="#FFFFCC">
		...
		<td width="126"><input type="text" name="tgl_awal" id="tgl_awal" size="10" class="required" title="Harap Mengisi Tanggal Awal Dahulu" value="<?php echo date('d-m-Y');?>" />
	...
	<tr bgcolor="#FFFFCC">
		<td>S/d</td>
		<td><input type="text" name="tgl_akhir" id="tgl_akhir" size="10" class="required" title="Harap Mengisi Tanggal Akhir Dahulu" value="<?php echo date('d-m-Y');?>" />
