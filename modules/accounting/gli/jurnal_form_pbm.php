...
$(document).ready(function() {
  ...
  <tr>
    ...
    <td width="1090"><span class="style1">JURNAL PEMBELIAN </span>
      <hr /></td>
  </tr>
  <tr>
    <td width="32">&nbsp;</td>
	...
	<form name="frmijin" id="frmijin" method="post" action="submission_gli.php">
      ...
      <tr>
		...
		<? if($_GET['supp']==""){?>
		<a href="daftar_supp.php?width=400&amp;height=350&amp;TB_iframe=true" class="thickbox"><img src="../assets/button_search.png" alt="Pilih Supplier" border="0" /></a>
		<? } ?>
