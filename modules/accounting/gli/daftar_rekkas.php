...
<?php 
 ...
 $SQL = "SELECT * FROM $database.rekening WHERE substr(norek, -3) <> '000' AND namarek LIKE 'Kas%' ORDER BY norek";
...
<table width="100%" bgcolor="#000000" cellspacing="1" cellpadding="3">	
	...
	<tr bgcolor="#FFFFFF">
		...
		<td align="center"><a href="javascript:selectBuku('<?php  echo $row->norek?>','<?php  echo $row->namarek?>')"><?php  echo $row->norek?></a></td>
