...
while($barisrek = mysql_fetch_array($hasilrek)) {
	...
	// insert nore ke dbfn
	$SQLi = "INSERT INTO $database.dbfn(norek, namarek, debet, kredit, saldoawal, saldoakhir, tipe, id, periode, divisi) VALUES('".$barisrek['norek']."', '".$barisrek['namarek']."', ".$barisrek['debet'].", ".$barisrek['kredit'].", '".$barisrek['saldoawal']."', '".$barisrek['saldoakhir']."', '".$barisrek['tipe']."', '".$a."', '".$_POST['tgl_awal'].' s/d '.$_POST['tgl_akhir']."', '".$divisi."')";
