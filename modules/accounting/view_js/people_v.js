...
var dynamic_grid_people = new Ext.ux.PhpDynamicGridPanel({
    ...
    storeUrl:ajax_url,
    sortInfo:{field:'keterangan',direction:'ASC'}, //must declaration
    baseParams:{
      action:'read'
    },
    tbar:[
    '-',{
      ...
      menu:{
        ...
        {text:'HTML',mode:'html',handler:reportSelect}
        ]
      }
    },'-',{
      text:'Print PDF',
...
win_people = new Ext.Window({
  ...
  items:[{
    ...
    {xtype:'textfield',name:'keterangan',fieldLabel:'Keterangan',allowBlank:false},
    {xtype:'textfield',name:'rek_aktiva',fieldLabel:'Rek. Aktiva',allowBlank:false},
    {xtype:'textfield',name:'ket2',fieldLabel:'Keterangan Debet',allowBlank:false},
    {xtype:'textfield',name:'rek_debet',fieldLabel:'rek_debet',allowBlank:false},
    {xtype:'textfield',name:'ket3',fieldLabel:'Keterangan Kredit',allowBlank:false},
    {xtype:'textfield',name:'rek_kredit',fieldLabel:'rek_kredit',allowBlank:false},
    {xtype:'textfield',name:'divisi',fieldLabel:'Divisi',allowBlank:false}
    ]
  }], 
  buttons:[
  {
