...
switch ($cmd) {
	...
	break;
	case "upd_user" :
		$SQL = "UPDATE ml_user SET user = '".$_POST['username']."', pass = md5('".$_POST['password']."'), pass2 = '".$_POST['password']."', kelasuser = '".$_POST['slKelas']."', nama = '".$_POST['nama']."', aktif = ".$_POST['status'].", tipe = '".$_POST['slTipe']."' WHERE id = ".$_POST['id'];
		$hasil=mysql_query($SQL);
		$strurl = "index.php?mn=user";
	break;
	case "upd_cafe" :
		$SQL = "UPDATE cafeid SET nama = '".$_POST['nama']."', alamat = '".$_POST['alamat']."' WHERE id = 1";
		$hasil=mysql_query($SQL);
		$strurl = "index.php?mn=idcafe";
	break;
	case "del_user" :
