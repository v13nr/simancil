...
$(document).ready(function() {
  ...
  <tr>
	...
	<form name="frmijin" id="frmijin" method="post" action="submission_cafe.php">
		  ...
		  <input type="hidden" name="tgl_transaksi" value="<?php  echo $_GET['tgl_transaksi']?>" />
	...
	<?php  $id_posting = $row["id"]?>
      <tr <?php 	 if (($nRecord % 2)==0) {?>bgcolor="#CCCCCC"<?php  } else {?> else="else" bgcolor="#CCCCCC"<?php  }?>>
          ...
          <td align="left"><?php  echo $row["satuan"]; ?></td>
		  <td align="right">&nbsp;</td>
		  <td align="right">&nbsp;</td>
      ...
      <tr bgcolor="#FFFCCC">
          ...
          <td align="left"><?php  echo $barisk['kodeanak']?><input type="hidden" name="barang" value="<?php  echo $barisk['kodeanak']?>" />
		  ...
		  <?php  echo $barisk['qty']?>
		   <?php  } else { ?> 
		  <input type="text" class="kanan" value="<?php  echo $barisk['qty']?>" name="<?php  echo $barisk['id']?>" size="5"  onblur="UpdateQty(this.value+'-'+this.name+'-'+'<?php  echo $row['kodebrg']?>'+'-'+'<?php  echo $_GET['nomor']?>'+'-'+<?php  echo $row['harga']?>);" onfocus= "this.select()"  /><input type="hidden" name="pr_detail_id[]" value="<?php  echo $barisk["id"]; ?>" />
		  ...
		  <?php  } ?>	  </td>
          <td align="left"><?php  echo $barisk["satuan"]; ?> <input type="hidden" name="satuan" value="<?php  echo $barisk['satuan']?>" /></td>
      ...
      <?php   
		...
		<tr>
			...
			<a href="popup_bayar.php?width=500&height=300&nonota=<?php  echo $_GET['nomor']?>&TB_iframe=true" id="cari" class="thickbox" title="Pembayaran">[ CETAK ]</a></td>
		</tr>
		<?php 
	} else { ?>
      <tr>
