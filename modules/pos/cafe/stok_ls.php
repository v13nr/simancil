...
**/
?>
<? @session_start(); include "otentik_admin.php"; 
...
<input type="hidden" name="cmd" value="del_stok" />
  <table width="1024" border="0" cellspacing="1" class="style3">
    <tr>
      ...
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td width="53" rowspan="3" valign="bottom"><div align="center" class="style4"><a href="persediaan_form.php"><img src="../draft/images/user_add.png" width="32" height="32" border="0" align="absbottom" class="style3" /></a></div></td>
    ...
    <tr>
      ...
      <td class="style3" colspan="1"><div align="left"><span class="style5"></span>Export To MS-Excell</div></td>
...
if (isset($_GET['page']))
	...
	$SQL = $SQL." ORDER BY grup DESC LIMIT "
    ...
    <tr <?	 if (($nRecord % 2)==0) {?>bgcolor="#e4e4e4"<? }  else {?>bgcolor="#FFFFCC"<? } ?>  class="simplehighlight">
	  ...
	  <td class="style3" align="center"><?
		...
		echo $barisc[0];
	  ?></td>
          <td class="style3" align="center"><?=$row['expedisi']?></td>
	  ...
	  <td class="style3" align="center"><?=number_format($row['isi'],2,'.',',')?></td>
      <td class="style3" align="center"><?=number_format($row['hargaeceran'])?></td>
      <td class="style3" align="center"><?=number_format($row['hargapartai'])?></td>
	  <td class="style3" align="center"><?=$row['tarif']?></td>
	  
      <td class="style3"><div align="center">
	  <a href="persediaan_form.php?mn=input_persediaan&id=<?=$row['kodebrg'] ?>"><img src="../draft/images/user_go.png" border="0" width="16" height="16"></a>
	  </div></td>
    </tr>
	<?  
		 $nRecord = $nRecord + 1;
