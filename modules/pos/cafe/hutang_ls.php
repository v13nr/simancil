...
function do_scroll(point)
{
  ...
  function show(page, div){
    do_scroll(0);
	var site = "http://localhost/erwin-nanang";
    $.ajax({
      url: site+"/"+page,
...
<input type="hidden" name="cmd" value="" />
  <table width="1024" border="0" cellspacing="1" class="style3">
    <tr>
      ...
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td width="53" rowspan="3" valign="bottom"><div align="center" class="style4"><a href="index.php?mn=pembelian"></a></div></td>
  ...
  <table width="1000" border="0" bgcolor="#000000" cellspacing="1">
    <tr height="30" background="../images/impactg.png">
      ...
      <td width="91" class="style3"><div align="center" class="style4">Nota </div></td>
      ...
      <td width="81" class="style3"><div align="center" class="style4">Jt Tempo </div></td>
