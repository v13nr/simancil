...
//		$SQL = $SQL." ORDER BY norek ASC";
    ...
    <tr <?	 if (($nRecord % 2)==0) {?>bgcolor="#e4e4e4"<? }  else {?>bgcolor="#FFFFCC"<? } ?>>
	  ...
	  { ?>
	  <a href="pemesanan_barang_edit.php?nomor=<?=$row['nomor']?>&sub=<?=$row['sub']?>&tgl_transaksi=<?=baliktglindo($row['tgl'])?>"><img src="../draft/images/user_go.png" border="0" width="16" height="16"></a>
	  <? } ?>
	  </div></td>
    </tr>
	<?  
