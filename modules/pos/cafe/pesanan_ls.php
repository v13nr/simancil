...
//		$SQL = $SQL." ORDER BY norek ASC";
    ...
    <tr <?php 	 if (($nRecord % 2)==0) {?>bgcolor="#e4e4e4"<?php  }  else {?>bgcolor="#FFFFCC"<?php  } ?>>
	  ...
	  { ?>
	  <a href="pemesanan_barang_edit.php?nomor=<?php  echo $row['nomor']?>&sub=<?php  echo $row['sub']?>&tgl_transaksi=<?php  echo baliktglindo($row['tgl'])?>"><img src="../draft/images/user_go.png" border="0" width="16" height="16"></a>
	  <?php  } ?>
	  </div></td>
    </tr>
	<?php   
