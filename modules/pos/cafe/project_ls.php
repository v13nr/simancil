...
<input type="hidden" name="cmd" value="" />
  <table width="1024" border="0" cellspacing="1" class="style3">
    <tr>
      ...
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td width="53" rowspan="3" valign="bottom"><div align="center" class="style4"><a href="index.php?mn=penjualan"></a></div></td>
...
//		$SQL = $SQL." ORDER BY norek ASC";
    ...
    <tr <?php 	 if (($nRecord % 2)==0) {?>bgcolor="#e4e4e4"<?php  }  else {?>bgcolor="#FFFFCC"<?php  } ?>>
      ...
      <td class="style3" align="let"><?php  echo "PR/".nobukti($row['nomor']);?></td>
	  ...
	  { ?>
	  <a href="pemesanan_project_rinci.php?project_id=<?php  echo $row['id']?>&nomor=<?php  echo $row['nomor']?>&sub=<?php  echo $row['sub']?>&tgl_transaksi=<?php  echo baliktglindo($row['tgl'])?>"><img src="../draft/images/user_go.png" border="0" width="16" height="16"></a>
	  <?php  } ?>
	  </div></td>
    </tr>
	<?php   
