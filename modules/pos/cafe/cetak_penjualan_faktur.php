...
$SQLj = "SELECT * FROM mutasi WHERE status = 1 AND model = 'INV' AND nomor = '".$_GET['nota']."'";
		//echo $SQLj; 		
...
$pdf->cell(30,6,'No Faktur : INV/' . $_GET['nota'], 0, 0, 'L');
$pdf->setY(48);	
...
$pdf->cell(35,6,number_format($row['qtyout']*$row['harga']), 1, 0, 'R');
$total = $total + ($row['qtyout']*$row['harga']);
$y = $y + 6;
