  ...
  <tr>
	...
	<form name="frmijin" id="frmijin" method="post" action="submission_inv.php">
      ...
      <tr>
        ...
        <td width="205"><input type="text" name="nonota" id="nonota" value="<?php echo $_GET["nonota"];?>"  required   class="required" /></td>
      ...
      <tr>
        <td>Konsumen </td>
        <td><input name="namapl" type="text" id="namapl"  required value="<?php echo $_GET["namasupp"];?>" class="data-entry-kanan"/>
          <input name="pembeli" type="text" id="pembeli"  required  value="<?php echo $_GET["pembeli"];?>" size="8" readonly="readonly" class="required" title="Kode Konsumen Harus Terisi !"/></td>
        <td>Saldo</td>
	...
	?>
      <tr <?php 	 if (($nRecord % 2)==0) {?>bgcolor="#FFFFFF"<?php  } else {?> else="else" bgcolor="#CCCCCC"<?php  }?>>
        <form action="submission_inv.php" method="post" name="frmijin" id="frmijin">
          ...
          <td align="right"><?php  echo number_format($row["ukuran1"],2,'.',',');?></td>
		  <td align="right"><?php  echo number_format($row["ukuran2"],2,'.',',');?></td>
		  <td align="right"><?php  echo number_format($row["ukuran3"],2,'.',',');?></td>
		  <td align="right"><?php  echo number_format($row["batang"],2,'.',',');?></td>
