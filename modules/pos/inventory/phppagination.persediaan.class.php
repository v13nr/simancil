...
class phpPagination {
    ...
    */
    ...
    function  phpPagination ($nTotalItems, $nItemsPerPage = 10, $options = NULL)
    {
		...
		$this->_first = '<a href="'.$_SERVER['PHP_SELF'].'?mn='.$_GET['mn'].'&nama='.$_GET['nama'].'&kdbarang='.$_GET['kdbarang'].'&group='.$_GET['group'].'&page=__PAGE_NUMBER__">&laquo;</a>';
		$this->_page = '<a href="'.$_SERVER['PHP_SELF'].'?mn='.$_GET['mn'].'&nama='.$_GET['nama'].'&kdbarang='.$_GET['kdbarang'].'&group='.$_GET['group'].'&page=__PAGE_NUMBER__">__PAGE_NUMBER__</a>';
		$this->_last = '<a href="'.$_SERVER['PHP_SELF'].'?mn='.$_GET['mn'].'&nama='.$_GET['nama'].'&kdbarang='.$_GET['kdbarang'].'&group='.$_GET['group'].'&page=__PAGE_NUMBER__">&raquo;</a>';
		$this->_prev = '<a href="'.$_SERVER['PHP_SELF'].'?mn='.$_GET['mn'].'&nama='.$_GET['nama'].'&kdbarang='.$_GET['kdbarang'].'&group='.$_GET['group'].'&page=__PAGE_NUMBER__">&lt;</a>';
    	$this->_next = '<a href="'.$_SERVER['PHP_SELF'].'?mn='.$_GET['mn'].'&nama='.$_GET['nama'].'&kdbarang='.$_GET['kdbarang'].'&group='.$_GET['group'].'&page=__PAGE_NUMBER__">&gt;</a>';
