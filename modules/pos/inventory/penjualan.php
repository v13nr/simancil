...
function kosongtextarray(){
  ...
  <tr>
	...
	<form name="frmijin" id="frmijin" method="post" action="submission_inv.php">
      ...
      <tr>
        <td>Alamat</td>
        <td><input type="text" name="alamat" id="alamat" readonly="true" size="40" value="<?=$_GET['alamat']?>"></td>
        <td>Rek</td>
	...
	<table border="1" align="left" cellpadding="3" cellspacing="0" bordercolorlight="silver" bordercolordark="#FFFFFF">
      ...
      <tr bgcolor="yellow">
          ...
          <td align="center"><input type="text" name="qty" id="qty" size="3" class="required kanan" title="*" onKeyUp="hitung()" />
            <select name="satuan" id="satuan" class="required" title="Satuan Harus terisi">
            </select>
          </td>
		  ...
		  <td align="center"><input type="text" name="disc2" id="disc2" size="2" class="required kanan" title="*" value="0"  onkeyup="hitung()" /></td>
		  <td align="center"><input type="text" name="disc3" id="disc3" size="2" class="required kanan" title="*" value="0"  onkeyup="hitung()" /></td>
