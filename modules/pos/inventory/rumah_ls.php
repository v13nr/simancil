...
<input type="hidden" name="cmd" value="del_stok" />
  <table width="1024" border="0" cellspacing="1" class="style3">
    <tr>
      ...
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td width="53" rowspan="3" valign="bottom"><div align="center" class="style4"><a href="index.php?mn=input_persediaanRumah"><img src="../draft/images/user_add.png" width="32" height="32" border="0" align="absbottom" class="style3" /></a></div></td>
 ...
 <table width="1000" border="0" bgcolor="#000000" cellspacing="1">
    ...
    <tr height="30" background="../images/impactg.png">
	  ...
	  <td width="35" class="style3"><div align="center" class="style4">Divisi</div></td>
          <td width="35" class="style3"><div align="center" class="style4">Norek</div></td>
...
if (isset($_GET['page']))
	...
	$sSQL = "select count(*) FROM stock where grup = 'Rumah' AND status = 1";
	if($_GET['kdbarang']<>""){
	...
	$SQL = "SELECT * FROM $database.stock where grup = 'Rumah' AND status = 1";
	if($_GET['kdbarang']<>""){
