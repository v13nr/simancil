...
<SCRIPT language=javascript src="popcalendar.js"></SCRIPT>
	...
	function onSelectChange(){
		//alert (nilai);
		$("#kartu").attr("href", "javascript:PopUp('kartu_sp.php?id="+$("input[@name='tambah[]']:checked").val()+"')");
	} 
function uncek() {
...
<input type="hidden" name="cmd" value="del_supp" />
  <table width="1024" border="0" cellspacing="1" class="style3">
    <tr>
      ...
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td width="53" rowspan="3" valign="bottom"><div align="center" class="style4"><a href="index.php?mn=input_supp"><img src="../draft/images/user_add.png" width="32" height="32" border="0" align="absbottom" class="style3" /></a></div></td>
  ...
  <tr height="30" background="../images/impactg.png">
    ...
    <tr height="30" background="../images/impactg.png">
      ...
      <td width="77" class="style3"><div align="center" class="style4">Kode Supplier </div></td>
      <td width="132" class="style3"><div align="center" class="style4">Divisi</div></td>
	  <td width="132" class="style3"><div align="center" class="style4">Nama</div></td>
	  <td width="375" class="style3"><div align="center" class="style4">Alamat</div></td>
