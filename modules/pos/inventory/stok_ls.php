...
if (isset($_GET['page']))
    ...
    <tr <?	 if (($nRecord % 2)==0) {?>bgcolor="#e4e4e4"<? }  else {?>bgcolor="#FFFFCC"<? } ?>  class="simplehighlight">
      ...
      <td class="style3" align="center"><?=$row['satuank']?></td>
      <td class="style3" align="center"><?=$row['satuanb']?></td>
	  <td class="style3" align="center"><?=$row['norek']?></td>
	  
      <td class="style3"><div align="center">
	  <a href="index.php?mn=input_persediaan&id=<?=$row['kodebrg'] ?>"><img src="../draft/images/user_go.png" border="0" width="16" height="16"></a>
	  </div></td>
    </tr>
	<?  
		 $nRecord = $nRecord + 1;
