    ...
    <td><form id="pegForm" method="post" name="pegForm" action="submission_inv.php">
      ...
      <table align="left" class="x1">
        ...
        <tr>
          ...
          <td><input type="text" name="satuank" id="satuank" class="required" title="Satuan Kecil harus terisi" value="<?=$satuank?>" /></td>
        </tr>
        <tr>
          <td><span class="style6">Partai </span></td>
          <td><span class="style6">:</span></td>
          <td><input name="satuanb" type="text" class="required" id="satuanb"  title="Satuan Besar harus diisi" value="<?=$satuanb?>" /></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>:</td>
          <td><input name="group" type="text" class="required" id="group"  title="Group harus diisi" value="<?=$group?>" /></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>:</td>
          <td><input type="text" name="norek" id="norek" maxlength="4" size="10" readonly="true" class="" title="Harap Mengisi Nomor Rekening Dahulu" value="<?=$norek?>"/>
