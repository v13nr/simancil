...
$y = $y + 16;
$pdf->setY($y);
$pdf->cell(30,6,'Cara Pembayaran', 0, 0, 'L');
$y = $y + 6;
$pdf->setY($y);
$pdf->cell(40,6,'- Membayar Uang Tanda jadi (booking fee) sebesar Rp. 5.000.000,- ditambah biaya administrasi sebesar Rp. 500.000,-.', 0, 0, 'L');
$y = $y + 6;
$pdf->setY($y);
$pdf->cell(40,6,'- Uang muka sdh harus dibayar selambat lambatnya 2(dua) minggu setelah tanda jadi(booking fee).', 0, 0, 'L');
$y = $y + 6;
$pdf->setY($y);
$pdf->cell(40,6,'- Pembatalan/pengunduran diri dengan alasan apapun, maka uang tanda jadi dianggap hangus, dan pengemabalian DP', 0, 0, 'L');
$y = $y + 6;
$pdf->setY($y);
$pdf->cell(40,6,'   akan dilakukan setelah ada user pengganti.', 0, 0, 'L');

$y = $y + 16;
$pdf->setY($y);
$pdf->cell(40,6,'Sales', 0, 0, 'C');
$pdf->cell(50,6,'Kasir', 0, 0, 'C');
$pdf->cell(50,6,'Admin', 0, 0, 'C');
$pdf->cell(50,6,'Menerima', 0, 0, 'C');
$y = $y + 20;
$SQL = "SELECT * FROM piutang WHERE nomor = '". $_GET["nomor"] ."'";
$hasil = mysql_query($SQL);
$baris = mysql_fetch_array($hasil);
$sales = $baris["sales"];
$kode_sales = $baris["kode_sales"];
$pdf->setY($y);
$pdf->cell(40,6,$sales.'/'.$kode_sales, 0, 0, 'C');
$pdf->cell(50,6,'', 0, 0, 'C');
$pdf->cell(50,6,'', 0, 0, 'C');
$pdf->cell(50,6,'', 0, 0, 'C');
