...
<input type="hidden" name="cmd" value="del_expedisi" />
  <table width="1024" border="0" cellspacing="1" class="style3">
    <tr>
      ...
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td width="53" rowspan="3" valign="bottom"><div align="center" class="style4"><a href="barang_in.php"><img src="../../images/user_add.png" width="32" height="32" border="0" align="absbottom" class="style3" /></a></div></td>
 ...
 <table width="1000" border="0" bgcolor="#000000" cellspacing="1">
    ...
    <tr height="30" background="../../images/impactg.png">
      ...
      <td width="150" class="style3"><div align="center" class="style4">Nama Pengirim</div></td>
      <td width="100" class="style3"><div align="center" class="style4">No Nota</div></td>
      <td width="310" class="style3"><div align="center" class="style4">Alamat Penerima</div></td>
	  
	  <td width="123" class="style3"><div align="center" class="style4">Total Ongkos</div></td>
...
if (isset($_GET['page']))
	...
	$sSQL = "select count(*) FROM expedisi where id <> ''";
	...
	$SQL = "SELECT * FROM expedisi where id <> ''";
	if($_GET['kdbarang']<>""){
			$SQL = $SQL . " AND nonota LIKE '%".$_GET['kdbarang']."%'";
		}
	if($_GET['group']<>""){
	...
	$SQL = $SQL." ORDER BY tanggal DESC LIMIT "
    ...
    <tr <?php 	 if (($nRecord % 2)==0) {?>bgcolor="#e4e4e4"<?php  }  else {?>bgcolor="#FFFFCC"<?php  } ?>  class="simplehighlight">
	  ...
	  <td class="style3" align="left"><?php  echo $row['nama_pengirim']?></td>
      <td class="style3" align="center"><?php  echo ($row['nonota'])?></td>
      <td class="style3" align="left"><?php  echo $row['alamat_penerima']?></td>
	  
	  <td class="style3" align="right" style="padding-right:5px"><?php  echo number_format($row['total_ongkos'])?></td>
	  
      <td class="style3"><div align="center">
	  <?php if($row["closing"] == "N") { ?>
	  [
	  <a href="barang_in.php?id=<?php  echo $row['id'] ?>">Edit</a>
	  ]
	  <?php } else { echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"; }?>
	  [<a href="barang_in_cetak.php?id=<?php echo $row['id']; ?>" target="_blank">Cetak 1</a>]
	  [<a href="surat_angkutan_cetak.php?id=<?php echo $row['id']; ?>" target="_blank">Cetak 2</a>]</div></td>
    </tr>
	<?php   
		 $nRecord = $nRecord + 1;
		} 
