...
switch ($cmd) {
	...
	case "del_stok" :
		...
		$banyaknya = count($id);
		for ($i=0; $i<$banyaknya; $i++) {
			$SQL = "UPDATE nas_produksi.stock SET status = 0 WHERE kodebrg = '".$id[$i]."'";
			$hasil = mysql_query($SQL, $dbh_jogjaide);
		}
	...
	case "add_stok" :
		...
		$SQL = "INSERT into nas_produksi.stock(tarif, kodebrg, divisi, expedisi, namabrg, satuank, isi, satuanb, grup, modal, norek, hargaeceran, hargapartai, jenis, status) VALUES('".$_POST['tarif']."','".$_POST['kodebrg']."','".$_POST['divisi']."','".$_POST['expedisi']."','".$_POST['namabrg']."','".$_POST['satuank']."','".$isi."','".$_POST['satuanb']."','".$_POST['group']."','".$modal."','".$_POST['norek']."',  '".$hargaeceran."',  '".$hargapartai."', '".$_POST['jenis']."',1)";
	...
	case "upd_stok" :
		...
		$SQL = "UPDATE nas_produksi.stock SET namabrg = '".$_POST['namabrg']."', divisi = '".$_POST['divisi']."', jenis = '".$_POST['jenis']."', expedisi = '".$_POST['expedisi']."', satuank = '".$_POST['satuank']."',tarif = '".$_POST['tarif']."', isi = '".$isi."', satuanb = '".$_POST['satuanb']."', grup = '".$_POST['group']."', modal = '".$modal."', norek = '".$_POST['norek']."', kodebrg = '".$_POST['kodebrg']."', hargaeceran = '".$hargaeceran."', hargapartai = '".$hargapartai."' WHERE kodebrg = '".$_POST['id']."'";
		//echo $SQL; exit();
		$hasil = mysql_query($SQL, $dbh_produksi);
		$strurl = "stok_ls.php";
	break;
