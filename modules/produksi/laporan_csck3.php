...
<br />
<form method="POST" action="cetak_csck3.php" id="frmijin">
  <table width="680" align="center" cellspacing="1" bgcolor="#000000">
    <tr background="../images/impactg.png" height="30">
      <td colspan="5" align="center"><strong><font color="#FFFFFF">LAPORAN CK4C </font></strong> </td>
    </tr>
    <tr bgcolor="#FFFFCC">
      ...
      <td width="209"><input type="text" name="tgl_awal" id="tgl_awal" size="10" value="01-01-2010" class="required" title="Harap Mengisi Tanggal Awal Dahulu" />
        <a href="javascript:showCalendar('tgl_awal')"><img src="../../assets/kalendar_files/calendar_icon.gif" alt="Z" border="0" /></a></td>
    ...
    <tr bgcolor="#FFFFCC">
      ...
      <td><input type="text" name="tgl_akhir" id="tgl_akhir" size="10" class="required" title="Harap Mengisi Tanggal Akhir Dahulu" value="31-12-2010" />
        <a href="javascript:showCalendar('tgl_akhir')"><img src="../../assets/kalendar_files/calendar_icon.gif" alt="A" border="0" /></a></td>
      <td>No. Rek </td>
